...
app.get("/api/cuspide/:isbn", async (req, res) => {
  ...
  try {
    ...
    console.log(`[CÚSPIDE] URL de búsqueda: ${searchUrl}`);
    ...
    console.log(`[CÚSPIDE] Estado de respuesta: ${response.status}`);
    ...
    console.log(
      `[CÚSPIDE] Enlace de detalle encontrado: ${detalleUrl || "No encontrado"}`
    );
    ...
    console.log(`[CÚSPIDE] URL completa de detalle: ${fullDetailUrl}`);
    ...
    console.log("[CÚSPIDE] Datos obtenidos:", {
      titulo,
      autor,
      editorial,
      precio,
    ...
    console.error("[CÚSPIDE] Error completo:", error);
    res.status(500).json({
